...
description: Use this guide to improve next-page load performance (including LCP) by instructing the browser to prefetch or prerender likely upcoming page views before the user explicitly navigates to them.
---
